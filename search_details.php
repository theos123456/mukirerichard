...
<?php
 $categoryid=$_SESSION['sub-cat']; 
 $query1="select dist_id from district where name='".$_SESSION['district']."'";
 $result1=$conn->query($query1);
 $info=$result1->fetch_assoc();
 $sqlquery="select pub_id, prod_name, unit_price, address from publication where (sub_category='$categoryid' and dist_id='".$info['dist_id']."')";
?>
...
<div class="products-container">
<?php
$sqlquery1="select pub_id, prod_name, unit_price, address from publication where sub_category='$categoryid' and dist_id!='".$info['dist_id']."'";
...
<tr><td colspan="3" style="height:auto;"><?php include_once 'footer.php'; ?></td></tr>
  ...
  <div class="header">
	...
	<a href="music-index.php"onmouseover="javascript:document.getElementById('login-form').style.visibility='hidden';">Entertainment</a>
